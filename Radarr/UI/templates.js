...
this["T"]["cells/movielinks"] = {"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, buffer = "<span class=\"series-info-links\">\n";
  ...
  if (stack1 != null) { buffer += stack1; }
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.tmdbId : depth0), {"name":"if","hash":{},"fn":this.program(5, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.imdbId : depth0), {"name":"if","hash":{},"fn":this.program(7, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "\n";
...
this["T"]["addmovies/bulkimport/moviepath"] = {"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "\" class=\"hint\" style=\"font-size: 12px;\">";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.movieFile : depth0)) != null ? stack1.relativePath : stack1), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.program(3, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "</span>\n";
},"useData":true};
